...
export default function Analytics() {
  ...
  const timeByPriority = {
    high: tasks.filter((t: Task) => t.priority === 'high' && t.estimatedTime)
      .reduce((sum: number, t: Task) => sum + parseFloat(t.estimatedTime || '0'), 0),
    medium: tasks.filter((t: Task) => t.priority === 'medium' && t.estimatedTime)
      .reduce((sum: number, t: Task) => sum + parseFloat(t.estimatedTime || '0'), 0),
    low: tasks.filter((t: Task) => t.priority === 'low' && t.estimatedTime)
      .reduce((sum: number, t: Task) => sum + parseFloat(t.estimatedTime || '0'), 0),
  }
